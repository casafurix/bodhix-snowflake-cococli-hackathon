-- ATLAS — Advanced Trial Lifecycle & Analytics System: shared Snowflake Workspace
...
CREATE WORKSPACE IF NOT EXISTS CTOPS_HACKATHON.COLLAB.TRIALOPS_SHARED
  COMMENT = 'Shared CoCo and SQL collaboration workspace for ATLAS — Advanced Trial Lifecycle & Analytics System';
